...
export default function Page() {
  ...
  const filteredappoinment = appointments.filter(
    (d) =>
  ...
  const totalPages = Math.ceil(filteredappoinment.length / ITEMS_PER_PAGE);
  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;
  const currentAppointments = filteredappoinment.slice(
    startIndex,
